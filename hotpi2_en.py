...
def process_event(event):
    ...
    if event.type == EventType.ON_DEVICE_ACTION:
        for command, params in event.actions:
            ...
            if command == "com.larobotics.commands.Move":
                ...
                if speed_str == 'SLOWLY':
                    ...
                    speed = 200
                msg=[go_direction,time,speed]
                print("MOVE :", msg)
                

            elif command == "com.larobotics.commands.Turn":
            ...
            elif command == "com.larobotics.commands.TakePhoto":
                print("TAKE A PHOTO")

            elif command == "com.larobotics.commands.Automatic":
                print("AUTOMATIC")
...
def main():
    ...
    #client_socket.connect(('192.168.1.47', 8545))
